...
public class CreateRegistrationProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        List<StudentEntity> studentRecords = studentService.findByOidOrPersonIdOrderByTimestampDesc(request.getStudent().getOid(),
                request.getStudent().getPersonId());
        ...
        RegistrationEntity registrationEntity = registrationService.create(modelMapper.map(request, RegistrationEntity.class));
