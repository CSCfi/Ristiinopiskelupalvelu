...
public class StudiesServiceIntegrationTest {

    private static final Logger logger = LoggerFactory.getLogger(StudiesServiceIntegrationTest.class);
    ...
    public void testSearchOrganizingOrganisationFiltering_shouldReturnOnlyOtherOrganizerStudies() {
        ...
        InternalStudiesSearchResults results = this.studiesService.search(organisationRunningQuery, params);
    ...
    public void testSearchStudyElementNetworkValidityFiltering_shouldExcludeAllNonValidNetworks() {
        ...
        InternalStudiesSearchResults results = this.studiesService.search(organisationRunningQuery, searchParameters);
    ...
    public void testSearchNameFiltering_shouldBeCaseInsensitive() {
        ...
        InternalStudiesSearchResults engSearchResults = this.studiesService.search(organisationRunningQuery, enSearchParameters);
        ...
        InternalStudiesSearchResults svSearchResults = this.studiesService.search(organisationRunningQuery, svSearchParameters);
    ...
    public void testOrganisationFiltering_shouldReturnStudyElementsWithOnlyGivenOrganisations() {
        ...
        InternalStudiesSearchResults searchResults = this.studiesService.search(organisationRunningQuery, searchParameters);
        ...
        InternalStudiesSearchResults includeOwnSearchResults = this.studiesService.search(organisationRunningQuery, includeOwnSearchParameters);
    ...
    public void testTypeFiltering_shouldReturnTypedResults() {
        ...
        InternalStudiesSearchResults searchResults = this.studiesService.search(organisationRunningQuery, cuSearchParameters);
        ...
        InternalStudiesSearchResults allSearchResults = this.studiesService.search(organisationRunningQuery, allSearchParameters);
        ...
        InternalStudiesSearchResults smSearchResults = this.studiesService.search(organisationRunningQuery, smSearchParameters);
