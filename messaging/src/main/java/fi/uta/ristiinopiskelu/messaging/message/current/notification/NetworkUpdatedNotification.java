...
public class NetworkUpdatedNotification implements Notification {

    private OffsetDateTime timestamp;
    private NetworkWriteDTO network = null;

    public NetworkUpdatedNotification() {
    }

    public NetworkUpdatedNotification(OffsetDateTime timestamp, NetworkWriteDTO network) {
