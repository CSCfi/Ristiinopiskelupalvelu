...
import fi.uta.ristiinopiskelu.messaging.message.v8.courseunit.UpdateCourseUnitRequest;
import fi.uta.ristiinopiskelu.messaging.message.v8.network.CreateNetworkRequest;
import fi.uta.ristiinopiskelu.messaging.message.v8.network.UpdateNetworkRequest;
...
import fi.uta.ristiinopiskelu.messaging.message.v8.realisation.DeleteRealisationRequest;
import fi.uta.ristiinopiskelu.messaging.message.v8.realisation.UpdateRealisationRequest;
