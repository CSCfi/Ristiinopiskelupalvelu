...
public class StudiesSearchResults extends ListSearchResults<AbstractStudyElementReadDTO> {
    ...
    public StudiesSearchResults(List<AbstractStudyElementReadDTO> results, List<SimpleAggregationDTO> aggregations, long totalHits) {
        super(results);
