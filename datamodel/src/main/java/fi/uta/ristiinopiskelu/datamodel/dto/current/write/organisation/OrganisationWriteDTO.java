package fi.uta.ristiinopiskelu.datamodel.dto.current.write.organisation;
 ...
 */
public class OrganisationWriteDTO {
    ...
    public OrganisationWriteDTO organisationName(LocalisedString organisationName) {
        this.organisationName = organisationName;
        return this;
    }

    public OrganisationWriteDTO addOrganisationNameItem(LocalisedString organisationNameItem) {
    ...
    public OrganisationWriteDTO unitName(LocalisedString unitName) {
        this.unitName = unitName;
        return this;
    }

    public OrganisationWriteDTO addUnitNameItem(LocalisedString unitNameItem) {
    ...
    public boolean equals(Object o) {
        OrganisationWriteDTO that = (OrganisationWriteDTO) o;
