package fi.uta.ristiinopiskelu.datamodel.dto.current.read.network;
...
public class NetworkReadDTO {
    ...
    public static NetworkReadDTO fromEntity(NetworkEntity entity) {
        NetworkReadDTO network = new NetworkReadDTO();
