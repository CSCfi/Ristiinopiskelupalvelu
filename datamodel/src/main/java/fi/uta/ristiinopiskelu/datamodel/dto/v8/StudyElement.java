...
@JsonSubTypes({
    @JsonSubTypes.Type(value = StudyModule.class, name = "STUDY_MODULE"),
    @JsonSubTypes.Type(value = CourseUnit.class, name = "COURSE_UNIT"),
    @JsonSubTypes.Type(value = Degree.class, name = "DEGREE")
})
...
public abstract class StudyElement {
    ...
    private List<StudyElement> subElements;
     ...
     */
    public List<StudyElement> getSubElements() {
      return subElements;
    }
     ...
     */
    public void setSubElements(List<StudyElement> subElements) {
