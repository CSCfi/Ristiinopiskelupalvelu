package fi.uta.ristiinopiskelu.datamodel.dto.current.read.studyelement;
...
@JsonSubTypes({
    @JsonSubTypes.Type(value = StudyModuleReadDTO.class, name = "STUDY_MODULE"),
    @JsonSubTypes.Type(value = CourseUnitReadDTO.class, name = "COURSE_UNIT"),
    @JsonSubTypes.Type(value = DegreeReadDTO.class, name = "DEGREE")
})
@JsonInclude(NON_NULL)
public abstract class AbstractStudyElementReadDTO {
    ...
    private List<AbstractStudyElementReadDTO> subElements;
     ...
     */
    public List<AbstractStudyElementReadDTO> getSubElements() {
        return subElements;
    }
     ...
     */
    public void setSubElements(List<AbstractStudyElementReadDTO> subElements) {
