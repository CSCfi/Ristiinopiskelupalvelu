...
public class Organisation {
    ...
    public Organisation organisationName(LocalisedString organisationName) {
        this.organisationName = organisationName;
        return this;
    }

    public Organisation addOrganisationNameItem(LocalisedString organisationNameItem) {
    ...
    public Organisation unitName(LocalisedString unitName) {
        this.unitName = unitName;
        return this;
    }

    public Organisation addUnitNameItem(LocalisedString unitNameItem) {
